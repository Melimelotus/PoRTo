...
def all_type_suffixes():
    ...
    allTypes=utils.merge_dicts([nomenclature.suffixes_nonDagNodeTypes,
...
def all_suffixes():
    ...
    allSuffixes=utils.merge_dicts([nomenclature.suffixes_nonDagNodeTypes,
                                    nomenclature.suffixes_dagNodeTypes,
...
def from_node_type_get_suffix(nodeTypeStr):
    ...
    suffix = utils.get_dict_keys_from_value(nodeTypeStr, all_type_suffixes())
