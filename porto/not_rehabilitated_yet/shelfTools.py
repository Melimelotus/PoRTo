...
class CurveShapeSelector():
    """UI. Change the curve shape of selected objects."""
    def __init__(self):
        self.toolName="Curve Shape Selector"
        self.icon=''
...
class ConnectOffsetParentMatrix():
    ...
    def __init__(self):
        ...
        self.icon='offsetParentMatrix.png'
...
class SelectionToLocator():
    ...
    def __init__(self):
        ...
        self.icon='selectionToLocator.png'
...
class SelectionToHierarchy():
    ...
    def __init__(self):
        ...
        self.icon='selectionToHierarchy.png'
...
class QuickplaceSelectionMultipleFollowers():
    ...
    def __init__(self):
        ...
        self.icon='quickplaceMultiple.png'
...
class QuickplaceSelectionSingleFollower():
    ...
    def __init__(self):
        ...
        self.icon='quickplaceSingle.png'
